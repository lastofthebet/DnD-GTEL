...
var html_url_prefix = "/DnD-GTEL";
var CONFIGURED_HTML_URL_PREFIX = "/DnD-GTEL";
...
var gzip_hash = '62371628130522434901173050784355966708'                       // used to check whether the localStorage data is stale
...
function get_html_url_prefix(){
    return '/DnD-GTEL'  // this value is replaced by the actual url prefix when compiled
}
